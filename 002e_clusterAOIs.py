...
# USER INPUTS
# -----------------------------
#INPUT_RASTER = "Test3_2024_drivers_rasterized.tif" #manually labelled 2023
INPUT_RASTER = "00a_AUTO2024_drivers_rasterized.tif"
OUTPUT_GPKG = "00b_AUTO2024_defo_AOIs.gpkg"

BOX_SIZE_KM = 50        # Fixed box size (50x50 km)
N_BOXES = 15            # Number of boxes the user wants
